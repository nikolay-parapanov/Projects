...
def ss_login_and_options_scan():
    with sync_playwright() as p:
        ...
        # Debugging print statement to check if the correct HTML is being captured
        print(html_content)
        ...
        print("Headers found:", headers)  # Debugging print statement
        ...
        print("Extracted options data:", options_data)  # Debugging print statement
