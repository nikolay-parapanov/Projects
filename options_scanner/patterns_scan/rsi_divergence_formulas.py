...
def rsi_divergence_formulas_calcs(input_file):
    input_file = input_file
    if input_file == 'custom':
        df = pd.read_csv(r'C:\Users\npara\coding\np-github\Projects\options_scanner\rsi_divergence_files\step1_retrieve_finviz_beta.csv')
        print("Opening the step1 retrieve custome file ....")
        file_to_be_saved_single_use= 'step2_result_finviz_beta.csv'
        file_to_be_saved_filtered = 'step3_result_filtered_finviz_beta.csv'
        ...
        file_to_be_saved_single_use = 'step2_result_options_favourites.csv'
        file_to_be_saved_filtered = 'step3_result_filtered_options_favourites.csv'
    ...
    for i in range(len(df)):
        ...
        if df.at[i, 'be_pre_signal_last_10'] + df.at[i, 'be_close_below_SMA65'] == 3:  # Check if sum equals 3
    ...
    for i in range(len(df)):
        if df.at[i, 'bu_pre_signal_last_13'] + df.at[i, 'bu_close_above_SMA65'] == 3:
    ...
    print("RSI divergence scans signals have been saved ")
